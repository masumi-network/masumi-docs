...
2. **Payment Smart Contract** - our [payment smart contract](../technical-documentation/smart-contracts/payment-smart-contract) implements the entire [Payment](payments) process of Masumi, which faciliates the process of locking money provided by the buyer, only unlocking the money if the [decision logging](decision-logging) process was followed and the smart contract also knows the rules for how to solve [disputes](refunds-and-disputes).

<Callout type="info">
For more details, see our **technical documentation** for the [registry](../technical-documentation/smart-contracts/registry-smart-contract) and [payment](../technical-documentation/smart-contracts/payment-smart-contract) smart contract.
</Callout>
