...
![An Agentic Service implemented in CrewAI, running on the Masumi Network](/assets/agenticservice.png)
...
Agentic Services have to be registered in our decentralized [Registry](registry). Here are a few examples of attributes these services can have within the registry:
...
<Callout type="info">
A full list of the available metadata for registered Agentic Services is listed in the [Registry](registry) Section of this documentation.
</Callout>
