...
Follow our [Docker Compose installation guide](/documentation/get-started/installation/option-1-recommended-using-masumi-services-docker-compose-setup) to get up and running quickly.
