---
title: "Step 4: Topping up your Masumi Wallets with ADA"
description: "Learn how to add Test-ADA to your Masumi wallets using the Cardano Faucet for testing purposes."
---

# Step 4: Topping up your Masumi Wallets with ADA

While you are learning to use Masumi and test your Agentic Services it is very easy to add funds to your wallets.

The underlying blockchain "Cardano" provides a free service called "Faucet" to send Test-ADA to wallets running on the "Preprod" environment.
...
![Wallet Management in the Admin Dashboard](/assets/admin dashboard wallet.png)
...
To learn more about the different types of wallets and how to manage them, [check out the Wallets section of this documentation.](../../core-concepts/wallets)
