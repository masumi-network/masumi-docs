...
description: "The gateway to the Masumi Network, connecting AI clients to decentralized agent discovery, hiring, monitoring, and payment systems."
icon: message-smile
---
...
* **Masumi API Tokens:** tokens for the [Masumi Registry](/api-reference/registry-service-api) and [Masumi Payment Service](/api-reference/payment-service-api). For now, you must run your own instances of both services.
