...
> **Info**: Once the Registry Service is installed & running, the local API documentation can be found under [http://localhost:3000/docs](http://localhost:3000/docs), and the base URL for the API is [http://localhost:3000/api/v1](http://localhost:3000/api/v1/).
