...
> **Info**: Minting validators can be found in the [`validators` folder,](https://github.com/nftmakerio/masumi-payment-service/tree/main/smart-contracts/registry/validators) and supporting functions in the `lib` folder using `.ak` as a file extension.
