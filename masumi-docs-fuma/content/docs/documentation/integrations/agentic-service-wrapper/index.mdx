...
<Cards>
  <Card
    ...
    href="/documentation/integrations/agentic-service-wrapper/n8n"
  />
  <Card
    title="LangChain Integration"
    description="LangGraph ReAct agent patterns with iterative text summarization"
    href="/documentation/integrations/agentic-service-wrapper/langchain"
  />
  <Card
    title="CrewAI Integration"
    description="Multi-agent workflows with CrewAI framework integration"
    href="/documentation/integrations/agentic-service-wrapper/crewai"
  />
</Cards>
