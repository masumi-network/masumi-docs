...
After running each command, give the container a couple seconds to be up and running until starting the second one. The order is important.
...
* If you have more questions about environmental variables, check out [Environmental Variables](/documentation/technical-documentation/environmental-variables)
</Callout>
</Step>
