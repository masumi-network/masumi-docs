...
<Callout type="info">
  This content is automatically synced from the <a href="https://github.com/masumi-network/agentic-service-wrapper" target="_blank" rel="noopener noreferrer">masumi-network/agentic-service-wrapper</a> (branch: docs-prepare) repository.
</Callout>
