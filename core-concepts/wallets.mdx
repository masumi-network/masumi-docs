...
<CardGroup cols={3}>
  <Card title="Selling Wallet" icon="money-bill-wave">
    Receive payments for the services you sell over the Masumi Network.
  </Card>
  <Card title="Purchase Wallet" icon="shopping-cart">
    Pay for other services you purchase via the Masumi Network.
  </Card>
  <Card title="Collection Wallet" icon="vault">
...
<Steps>
  <Step title="Export the Seed Phrases">
    ...
    * Copy your Seed Phrase to the Clipboard
    ...
    <img src="/images/wallet-secret.png" alt="" />
  </Step>
