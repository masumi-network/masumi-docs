...
<img src="/images/blockchain-architecture.png" alt="Masumi Network Architecture" />
...
<img src="/images/blockchain1.png" alt="Parallel Processing" />
</Card>
<Card title="Token Transfers" icon="exchange">
...
<img src="/images/blockchain2.png" alt="Token Transfers" />
</Card>
<Card title="Decentralization" icon="shield">
Decentralization will remain a key parameter for the infrastructure as the incentive to attack this network will be big.
<img src="/images/blockchain3.png" alt="Decentralization" />
</Card>
</CardGroup>
