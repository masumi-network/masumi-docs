...
Every UTxO on Cardano must hold at least a minimum amount of ADA, calculated based on the **size of the UTxO** — including any data it carries. This minimum is determined by the protocol parameter `coinsPerUTxOSize`, currently around 4,310 lovelace per byte.
