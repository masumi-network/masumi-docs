...
<Callout type="info">
For detailed Railway deployment instructions, see the [Installation Guide](/documentation/get-started/installation#railway-templates) and this hosting guide. Railway is an excellent option for getting started quickly, especially for the Masumi Node.
</Callout>
...
<Callout type="info">
For basic Docker Compose setup instructions, see the [Installation Guide](/documentation/get-started/installation#docker-compose-recommended). The following section covers production deployment on a VPS.
</Callout>
