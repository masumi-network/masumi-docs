...
Take a look at the `crew_definition.py` file. It has a basic `ResearchCrew`. Here you can define your agent functionality. If you would like to develop your own agent crew, click [here](https://docs.crewai.com/en/concepts/agents) to learn more.
