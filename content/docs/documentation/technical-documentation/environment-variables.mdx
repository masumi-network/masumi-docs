...
| `WEBHOOK_DELIVERY_INTERVAL` | 10 s | Process outbound webhook deliveries (minimum 5 s) |
| `LOW_BALANCE_CHECK_INTERVAL` | 60 s | Check monitored wallet balances for low-balance alerts |
