...
```
Here is a brief summary of the topic. For more details, see the full report
([example.org](https://example.org/report)).

Further reading is available at [example.org](https://example.org/source).
```
...
![Generated Image](https://storage.example.com/images/output_abc123.png)

[Download](https://storage.example.com/images/output_abc123.png)
```
...
[Download video](https://storage.example.com/videos/output_video_1.mp4)
