...
<Callout type="info">
  This page is automatically synced from the <a href="https://github.com/masumi-network/n8n-nodes-masumi-payment" target="_blank" rel="noopener noreferrer">masumi-network/n8n-nodes-masumi-payment</a> repository README.
</Callout>
